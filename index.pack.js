...
var _jsConfetti = __webpack_require__(0);

var _jsConfetti2 = _interopRequireDefault(_jsConfetti);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var jsConfetti = new _jsConfetti2.default();
...
var rewardButton = document.getElementById("reward-button").addEventListener("click", function () {
    rewardContainer.style.display = "none";
    var timeHide = setTimeout(function () {
        return rewardContainer.style.display = "block";
    }, 1000);
    reward.textContent = getRandomNumber();
});
var reward = document.getElementById('show-reward');
function fireConfetti() {
    jsConfetti.addConfetti({
        confettiRadius: 4,
        confettiColors: ['#FE486C', '#1BCA8D', '#AEBCCD'],
        confettiNumber: 100,
        emojis: ['🌐', '💘❤', '⚗️', '☄️', '🍻🎉', '💍'],
        emojiSize: 25
    });
